...
// Update if you have a more relevant image
  ...
  return (
    <>
      <main className="bg-[#F8F8F8] text-[#333] py-12">
        {/* Hero Section */}
        <section className="relative bg-[#110f3e] text-white mb-20 bg-[url('./images/medical-c.jpg')] bg-cover bg-center bg-no-repeat">
          {/* Dark Overlay */}
