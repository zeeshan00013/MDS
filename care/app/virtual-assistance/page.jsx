  ...
  return (
    <>
      <main className="bg-[#F8F8F8] text-[#333] py-12">
        {/* Hero Section */}
        <section className="relative bg-[#110f3e] text-white mb-20 bg-[url('/assistance.jpg')] bg-cover bg-center bg-no-repeat">
          {/* Dark Overlay */}
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center gap-10">
            <div className="flex-1">
              <h1 className="text-3xl md:text-4xl font-medium leading-tight mb-6 max-w-3xl">
                Revenue Align Solutions – Trusted Virtual Assistance for
                Healthcare Providers
              </h1>
              <p className="text-lg mb-6 max-w-lg">
                Partner with Revenue Align Solutions for reliable,
                HIPAA-compliant virtual assistants who improve efficiency while
        ...
        <section className="max-w-7xl mx-auto text-center items-center gap-10 mb-20 px-6">
          <h2 className="text-3xl font-semibold text-[#362d7e] mb-4">
            End-to-End Virtual Assistant Support by Revenue Align Solutions
          </h2>
          <p className="mb-4">
            <strong>Revenue Align Solutions</strong> provides professional
            virtual assistant services tailored to your medical practice’s
        ...
        <section className="max-w-7xl mx-auto mb-20">
          <h2 className="text-3xl font-medium text-[#362d7e] mb-6 text-center">
            Why Choose Revenue Align Solutions for Virtual Assistance?
          </h2>
        ...
        <section className="max-w-7xl mx-auto px-4 mb-10 flex flex-col items-center">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-[#362d7e] w-4/6 text-center">
            Why Healthcare Providers Trust Revenue Align Solutions for Virtual
            Support
          </h2>
