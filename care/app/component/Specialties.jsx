  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-16 text-center flex flex-col items-center justify-center ">
      <h2 className="text-3xl font-bold  text-center  mb-4 text-zinc-900">
        ...
        <span className="text-[#362d7e]"> Transcure Serve </span> <br /> with
        Expert Billing?
      </h2>
      <p className="text-gray-600 max-w-2xl mx-auto mb-12">
        Our medical billing company cater to a wide range of specialties,
        spanning from primary care to surgical centers, serving small and
        mid-sized practices.
      </p>
